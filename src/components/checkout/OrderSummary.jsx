...
export default function OrderSummary({ onBack, onEditAddress, onDeleteAddress }) {
  const router = useRouter();
  const [showDeleteConfirm, setShowDeleteConfirm] = useState(false);
  const [isDeleting, setIsDeleting] = useState(false);

  const { address, loading: addressLoading } = useSelector(state => state.address);
    ...
    <div className="space-y-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="mt-2 text-gray-700">{address.streetAddress}</p>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h3 className="text-lg font-medium text-gray-900 mb-4 flex items-center">
          ...
          Your Cart ({cartLoading ? '...' : cartData?.totalItem || 0} items)
        </h3>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-[#4f39f6] font-medium">₹{item.price}</span>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-green-600">-₹{cartData?.discounte?.toLocaleString()}</span>
            </div>
            <div className="flex justify-between">
            ...
            {cartData?.discounte > 0 && (
              <div className="text-green-600 text-sm">
                You will save ₹{cartData?.discounte?.toLocaleString()} on this order
              </div>
            )}
          </div>
        </div>
