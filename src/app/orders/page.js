          ...
          <div className="lg:w-3/4">
            ...
            {filteredOrders.length === 0 && (
              <div className="text-center py-12 bg-white rounded-xl shadow-sm">
                ...
                <p className="text-gray-600 mb-4">There are no orders matching your current filters.</p>
                <button
...
export default Order;// 'use client';
// import React, { useState } from 'react';
// import OrderCard from '../../components/order/OrderCard.jsx';
...
//       <div className="flex flex-col lg:flex-row gap-6">
//         {/* Order Filter */}
//         <div className="lg:w-1/4 bg-white rounded-lg shadow-sm p-6">
//           <h1 className="text-xl font-semibold mb-6">Filter</h1>
//           <div className="space-y-4">
...
//                   />
//                   <label htmlFor={item.id} className="ml-2 text-gray-700 cursor-pointer">
//                     {item.value}
//                   </label>
//                 </div>
//               ))}
