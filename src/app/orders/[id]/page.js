...
// const OrderDetail = () => {
//   return (
//     <div className="container mx-auto px-5  md:px-10 lg:px-30 py-8">
...
//                   src="https://m.media-amazon.com/images/I/61DGAlvxRLL._SY550_.jpg" 
//                   alt="Men Slim Mid Black Jeans"
//                 />
//                 <div>
//                   <h3 className="text-lg font-semibold">Men Slim Mid Black Jeans</h3>
//                   <div className="flex gap-4 mt-1">
//                     <p className="text-gray-600">Color: Pink</p>
//                     <p className="text-gray-600">Size: M</p>
//                   </div>
//                   <p className="text-gray-600 mt-1">Seller: Tokyo Fashion</p>
//                   <p className="text-lg font-medium mt-2">₹900</p>
//                 </div>
//               </div>

//               {/* Rating Button */}
//               <button className="flex items-center gap-2 text-indigo-600 hover:text-indigo-800 mt-4 md:mt-0">
//                 <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
//                   <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
//                 </svg>
